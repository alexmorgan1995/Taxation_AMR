...
ggarrange(dyn_flat, tax_flat, nrow = 2, ncol = 1, common.legend = T, legend = "bottom")
...
testdyn <- read.csv("/Users/amorgan/Documents/PostDoc/PrelimAnalysis/Theoretical_Analysis/Model_Output/dynamicoutput.csv")[-1]
...
totinf_data <- data.frame("time" = seq(0, 10000),
                          ...
                          "DiffTaxDyn" = rowSums(testdyn[3:6]))
                          
totinfmelt <- melt(totinf_data, id.vars = c("time"), measure.vars = c("FlatTax", "SingleDiffTax", "DiffTax", "DiffTaxDyn"))  
...
totres_data <- data.frame("time" = seq(0, 10000),
                          ...
                          "DiffTaxDyn" = rowMeans(testdyn[4:6]))

totres_melt <- melt(totres_data, id.vars = c("time"), measure.vars = c("FlatTax", "SingleDiffTax", "DiffTax", "DiffTaxDyn"))   
...
inf_int = data.frame("flat" = integral(testrun_flat, 3000), 
           ...
           "diffdyn" = integral(testdyn, 3000))

write.csv(inf_int, file = "/Users/amorgan/Documents/PostDoc/PrelimAnalysis/Theoretical_Analysis/Model_Output/integrals_v1.csv")
...
ggarrange(totinf, avgres, nrow = 1, ncol = 2, common.legend = T, legend = "bottom")
