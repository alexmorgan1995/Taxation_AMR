    ...
    for(i in 2:int_gen) {
      ...
      if(values[1] == 0 & values[2] == 0 & values[3] == 0) {
        ...
        if(max(values) == min(values)) {
          ...
          parms[["eff_tax"]][1, c((i):6)] <- (((1+as.numeric((parms[["base_tax"]]*(tail(run[names(values)[which.min(values)]],1)/values_1rd[med_char_1rd])))) -
                                                                                  (1+parms[["eff_tax"]][1, (i-1)]))/ (1+parms[["eff_tax"]][1, (i-1)]))
          parms[["eff_tax"]][2, c((i):6)] <- (((1+as.numeric((parms[["base_tax"]]*(tail(run[names(values)[which.min(values)]],1)/values_1rd[med_char_1rd])))) -
                                                                                   (1+parms[["eff_tax"]][2, (i-1)]))/ (1+parms[["eff_tax"]][2, (i-1)]))
          parms[["eff_tax"]][3, c((i):6)] <- (((1+as.numeric((parms[["base_tax"]]*(tail(run[names(values)[which.min(values)]],1)/values_1rd[med_char_1rd])))) -
                                                                                  (1+parms[["eff_tax"]][3, (i-1)]))/ (1+parms[["eff_tax"]][3, (i-1)]))
...
#ßtestres_single <- fast99(model = ode_function, factors = factors, n = 200, 
