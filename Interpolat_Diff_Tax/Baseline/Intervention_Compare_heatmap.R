...
testrun_flat <- list(ode_wrapper(y = init, func = amr, times = seq(0, 10000), parms = parms1, approx_sigma))
...
base <- ode_wrapper(y = init, func = amr, times = seq(0, 10000), parms = parms, approx_sigma)[[1]]
