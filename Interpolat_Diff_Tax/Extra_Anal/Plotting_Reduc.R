...
parms <- readRDS("/Users/amorgan/Desktop/MDR_run_parms_ban.RDS")[[242]]
parms <- readRDS("/Users/amorgan/Desktop/MDR_run_parms_ban.RDS")[[350]]
parms <- readRDS("/Users/amorgan/Desktop/MDR_run_parms_ban.RDS")[[942]]
# Baseline ----------------------------------------------------------------
...
base_tot_inf <- signif(sum(run_base[3:10]), 5)
base_int_res <- signif(sum(rowMeans(run_base_agg[4:6])), 5)

base_data <- data.frame("time" = seq(0, 10000), "avgres" = rowMeans(run_base_agg[,4:6]))
