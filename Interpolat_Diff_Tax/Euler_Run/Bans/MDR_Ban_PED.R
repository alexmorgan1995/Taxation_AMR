...
parm_data <- data.frame(t(replicate(10000, runif(31, low_parm, high_parm))))
...
colnames(parm_data) <- c("lambda", "beta", "sigma1", "sigma2", "sigma3", 
                         ...
                         "rho", "PED11", "PED22", "PED33",
                         "PED12","PED13","PED21","PED23","PED31","PED32")
...
mono_func <- function(n, parms_frame, init, amr_ode, usage_fun, multi_int_fun, low_parm, high_parm, agg_func, thresh, ode_wrapper, approx_sigma, ban_wrapper) {
  ...
  PED = matrix(c(parms_frame[n,"PED11"], parms_frame[n,"PED12"], parms_frame[n,"PED13"], 
                 parms_frame[n,"PED21"], parms_frame[n,"PED22"], parms_frame[n,"PED23"],
                 parms_frame[n,"PED31"], parms_frame[n,"PED32"], parms_frame[n,"PED33"]), #Be aware of this matrix
               nrow = 3, ncol = 3, byrow = T)
  
  parms_base = as.list(parms_frame[n,c(1:22, 32, 33, 34)])
...
parm_data_comb_new[1:nrow(comb_data),1:25] <- comb_data[,53:77]
...
#Save the output
saveRDS(parm_list, "/cluster/home/amorgan/Sens_Anal_Output/MDR_parms_PED.RDS")
saveRDS(comb_data_new, "/cluster/home/amorgan/Sens_Anal_Output/MDR_run_PED.RDS")
