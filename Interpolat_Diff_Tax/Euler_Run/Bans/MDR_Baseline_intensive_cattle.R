...
parms = list(lambda = 1/1095*(2), int_round = 1, 
             beta = 50, sigma1 = 0.25, sigma2 = 0.25, sigma3 = 0.25,
...
#Save the output
saveRDS(parm_list, "/cluster/home/amorgan/Sens_Anal_Output/MDR_parms_cattle_intensive.RDS")
saveRDS(comb_data_new, "/cluster/home/amorgan/Sens_Anal_Output/MDR_cattle_intensive.RDS")
