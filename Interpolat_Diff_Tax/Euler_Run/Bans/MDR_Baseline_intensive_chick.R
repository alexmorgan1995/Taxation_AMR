...
parms = list(lambda = 1/42*(2), int_round = 1, 
...
#Save the output
saveRDS(parm_list, "/cluster/home/amorgan/Sens_Anal_Output/MDR_parms_chick_intensive.RDS")
saveRDS(comb_data_new, "/cluster/home/amorgan/Sens_Anal_Output/MDR_chick_intensive.RDS")
