...
m_res$factors <- c(rep("Taxation", 9000), rep("Ban", 2000))
...
for(i in 1:11) {
  prop_1000 <- win_import_change[,c(12:22)[i]]
...
m_inf$factors <- c(rep("Taxation", 9000), rep("Ban", 2000))
...
m_avganti$factors <- c(rep("Taxation", 9000), rep("Ban", 2000))
