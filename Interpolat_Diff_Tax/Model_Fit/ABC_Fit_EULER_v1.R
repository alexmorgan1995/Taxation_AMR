...
ABC_algorithm <- function(N, G, single_run, distanceABC, fitmodel, init.state, epsilon, lm.low, lm.upp, thetaparm, ode_wrapper, approx_sigma)  {
  ...
  for(g in 1:G) {
    ...
    write.csv(res.old, file =  paste("/cluster/home/amorgan/Model_Fit_Output/ABC_v1_",g,".csv",sep=""), row.names=FALSE)
  }
  return(out)
}
...
saveRDS(test, file = "/cluster/home/amorgan/Model_Fit_Output/dist_list_v1.rds")
