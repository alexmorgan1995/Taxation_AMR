...
ode_wrapper <- function(times, y, parms, func) {
  ...
  #Run the model 
  out <- data.frame(ode(y = init, func = func, times = times, parms = parms, method = "ode45"))
  n_data <- ncol(out)-1
...
#Save the output
saveRDS(parm_list, "/cluster/home/amorgan/Sens_Anal_Output/MDR_run_parms_ode45.RDS")
saveRDS(comb_data_new, "/cluster/home/amorgan/Sens_Anal_Output/MDR_run_ode45.RDS")
