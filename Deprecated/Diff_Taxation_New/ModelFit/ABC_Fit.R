  ...
  for(g in 1:G) {
    ...
    while(i <= N) {
      ...
      if(g==1) {
        ...
        d_eta_wr <- runif(1, min = 0, max = 0.5)
        d_eta_rw <- runif(1, min = 0, max = 0.5)
...
saveRDS(dist_save, file = "/Users/amorgan/Documents/PostDoc/Diff_Tax_Analysis/Theoretical_Analysis/Diff_Taxation_New/ModelFit/dist_list.rds")
