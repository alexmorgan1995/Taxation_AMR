...
amr <- function(t, y, parms) {
  with(as.list(c(y, parms)), {
    ...
    dR1 = beta*S*R1 - (1-sigma_2)*mu_r1*R1 - sigma_2*mu_t*R1 - (1-sigma_1+sigma_2)*eta_rx_1*R1 + sigma_1*eta_xr_1*X
    
    dR2 = beta*S*R2 - (1-sigma_1)*mu_r2*R2 - sigma_1*mu_t*R2 - (1-sigma_1+sigma_2)*eta_rx_2*R2 + sigma_2*eta_xr_2*X
